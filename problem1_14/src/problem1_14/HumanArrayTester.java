...
public class HumanArrayTester {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < q.length; i++) {
			...
			System.out.print("신장:"); int height = input.nextInt();
			System.out.print("체중:"); int weight = input.nextInt();
		...
		Human[][] x = {
				...
				{new Human("홍길동", 178 , 70), new Human("김철수", 172 , 61)},
				{new Human("이영희", 168 , 59), new Human("김철수", 165 , 59)},
		};
		
		//배열과 각가의 인스턴스를 개별적으로 생성(불규칙 배열)
